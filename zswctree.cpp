...
void ZSwcTree::save(const char *filePath)
{
  ...
  if (!isEmpty()) {
    ...
    fprintf(fp, "# Generated by neuTube "
...
bool ZSwcTree::isIdValid() const
{
  ...
  for (Swc_Tree_Node *tn = begin(); tn != end(); tn = next()) {
    if (SwcTreeNode::isRoot(tn)) {
      if (SwcTreeNode::isRegular(tn) && SwcTreeNode::parentId(tn) != -1) {
#ifdef _DEBUG_
        std::cout << "Invalid id: ";
        Print_Swc_Tree_Node(SwcTreeNode::parent(tn));
        Print_Swc_Tree_Node(tn);
#endif
        valid = false;
        break;
      ...
      if (SwcTreeNode::parentId(tn) != SwcTreeNode::id(SwcTreeNode::parent(tn))) {
#ifdef _DEBUG_
        std::cout << "Invalid id: ";
        Print_Swc_Tree_Node(SwcTreeNode::parent(tn));
        Print_Swc_Tree_Node(tn);
    ...
    int id = SwcTreeNode::id(tn);
    if (SwcTreeNode::id(tn) >= 0) {
      //bug here. need to move out of the condition
      if (idSet.count(id) > 0) {
#ifdef _DEBUG_
