...
def ConnTestV2(swcPoint_list, graph, GSswcPoint_list, GSgraph, save_path, method = "svm"):
    temp_count = 0
    for p in swcPoint_list:
        if (p.n == 0): continue
    ...
    # print(temp_count)
    WriteGraph(graph, swcPoint_list, save_path)
...
if __name__ == '__main__':
    ...
    for filepath, dirnames, filenames in os.walk(home_path):
        for filename in filenames:
            ...
            ConnTestV2(swcPoint_list, graph, GSswcPoint_list, GSgraph, conn_res_path + filename[0:-13] + "_result.swc", "nn")
